...
module.exports = function (baseDir, pkg_json, code) {
  ...
  return Q.all([
    ...
    if (bundleExists) {
      ...
      return [fs.createReadStream(dir + '/bundle.js'), dir];
    }
  ...
  function buildBundle() {
    ...
    var b = bify();
    b.add(dir + '/index.js');
    var outFile = fs.createWriteStream(dir + '/bundle.js');
    var stream = b.bundle().pipe(tee(outFile));
    return [stream, dir];
  }
}
